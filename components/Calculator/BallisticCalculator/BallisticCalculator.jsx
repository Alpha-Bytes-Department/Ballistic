  ...
  return (
    <div className={`${design}`}>
      ...
      <form action="submit" className="flex flex-col gap-5 text-center">
        <div className="text-xl text-white bg-[#5c5c5b] py-3 rounded-xl">Units of Measure</div>
        ...
        <div className="text-xl text-white bg-[#5c5c5b] py-3 rounded-xl">Ammunition Inputs</div>
        ...
        <div className="text-xl text-white bg-[#5c5c5b] py-3 rounded-xl">Gun Inputs</div>
        ...
        <div className="text-xl text-white bg-[#5c5c5b] py-3 flex justify-between items-center px-5 rounded-xl">
